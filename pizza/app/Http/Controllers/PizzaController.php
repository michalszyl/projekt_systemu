...
class PizzaController extends Controller
{
    ...
    public function store(PizzaStoreRequest $request)
    {
        ...
        return redirect()->route('pizza.index')->with('message','Pizza stowrzona pomyślnie!');
    }
    ...
    public function update(PizzaUpdateRequest $request, $id)
    {
        ...
        $pizza->image = $path;
        $pizza->save();
        return redirect()->route('pizza.index')->with('message','Pizza zaaktualizowana pomyślnie!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pizza.index')->with('message','Pizza usunięta pomyślnie!');
    }
}
